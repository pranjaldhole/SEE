...
\subsubsection*{2. Compare the observed and commanded motions: do they fit? if not, describe possible causes for this.} {\color{green}{All readings up to significant digits.}}
\begin{itemize}
...
\caption{Gaussian fit for the data using scikit-learn KernelDensity function. {\color{green}{x labels with units.}}}
\label{gaussian}
\end{figure}
